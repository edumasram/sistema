...
class MarcasControllerTest < ActionController::TestCase
  ...
  test "should create marca" do
    assert_difference('Marca.count') do
      post :create, marca: { descricao.text: @marca.descricao.text, nome: @marca.nome, references: @marca.references }
    end
  ...
  test "should update marca" do
    put :update, id: @marca, marca: { descricao.text: @marca.descricao.text, nome: @marca.nome, references: @marca.references }
    assert_redirected_to marca_path(assigns(:marca))
  end
