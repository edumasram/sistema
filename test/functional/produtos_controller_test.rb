...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { cod_fornecedor: @produto.cod_fornecedor, estoque: @produto.estoque, nome: @produto.nome, sku: @produto.sku }
    end
  ...
  test "should update produto" do
    put :update, id: @produto, produto: { cod_fornecedor: @produto.cod_fornecedor, estoque: @produto.estoque, nome: @produto.nome, sku: @produto.sku }
    assert_redirected_to produto_path(assigns(:produto))
  end
